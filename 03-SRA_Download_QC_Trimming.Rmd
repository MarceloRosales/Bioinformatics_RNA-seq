...
See [Custom/personal way to Download the Mus_musculus_NCBI_build37.2.tar.gz file](#Mus_musculus_NCBI_build37.2) Section, or open section in a [new tab](https://marcelorosales.github.io/Bioinformatics_RNA-seq/index.html#custompersonal-way-to-download-the-mus_musculus_ncbi_build37.2.tar.gz-file){target="_blank"}  
