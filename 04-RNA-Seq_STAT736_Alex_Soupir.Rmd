...
based on: for STAT736 Alex Soupir Tutorial

```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = TRUE)
```

[ACSoupir/Bioinformatics_RNASeq/Mouse_RNA_Seq_p53_genotoxic.Rmd](https://github.com/ACSoupir/Bioinformatics_RNASeq/blob/master/Mouse_RNA_Seq_p53_genotoxic.Rmd) (Raw md file.)


See here for full view:  
[Mouse_RNA_Seq_p53_genotoxic.md.](https://github.com/ACSoupir/Bioinformatics_RNASeq/blob/master/Mouse_RNA_Seq_p53_genotoxic.md)
...
```{r heatmap, message = FALSE,fig.width=7,fig.height=7, eval=FALSE }
library(gplots)
...
```{r Medicago_trucatula_Database, eval=FALSE}
...
```{r Glycine_max_Database, eval=FALSE}
#BiocManager::install("AnnotationHub")
library(AnnotationHub)
hub = AnnotationHub()
